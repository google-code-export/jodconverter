...
class ManagedOfficeProcess {
    ...
    public ManagedOfficeProcess(ManagedOfficeProcessSettings settings) throws OfficeException {
        ...
        process = new OfficeProcess(settings.getOfficeHome(), settings.getUnoUrl(), settings.getRunAsArgs(), settings.getTemplateProfileDir(), settings.getInstanceProfileDir(), settings.isAutokillOpenPipes(), settings.getProcessManager());
